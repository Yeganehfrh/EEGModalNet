...
import keras
from .common_v0 import SubjectLayers, convBlock, ChannelMerger, SelfAttention1D, LearnablePositionalEmbedding, TCNResidualBlock
...
class Critic(keras.Model):
    def __init__(self,
        ...
        kernel_initializer = keras.initializers.RandomNormal(mean=0.0, stddev=0.02)  # TODO: update kernel initializer 
