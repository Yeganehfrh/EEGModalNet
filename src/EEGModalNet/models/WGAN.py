...
class Critic(keras.Model):
    def __init__(self, time_dim, feature_dim, n_subjects, use_sublayer, use_channel_merger, *args, **kwargs):
        ...
        self.model = keras.Sequential([
            ...
            layers.SpectralNormalization(layers.Conv1D(8, 15, strides=2, padding='same', activation='relu', name='conv3', kernel_initializer=kernel_initializer)),
            layers.SpectralNormalization(layers.Conv1D(8, 9, strides=2, padding='same', activation='relu', name='conv3', kernel_initializer=kernel_initializer)),
            layers.SpectralNormalization(layers.Conv1D(8, 7, strides=2, padding='same', activation='relu', name='conv4', kernel_initializer=kernel_initializer)),
            layers.SpectralNormalization(layers.Conv1D(8, 5, strides=2, padding='same', activation='relu', name='conv4', kernel_initializer=kernel_initializer)),
            layers.SpectralNormalization(layers.Conv1D(8, 3, strides=2, padding='same', activation='relu', name='conv4', kernel_initializer=kernel_initializer)),
            layers.SpectralNormalization(layers.Conv1D(8, 3, strides=2, padding='same', activation='relu', name='conv4', kernel_initializer=kernel_initializer)),
            ...
            layers.SpectralNormalization(layers.Dense(64, name='dis_dense1', kernel_initializer=kernel_initializer)),
            ...
            # layers.LeakyReLU(negative_slope=negative_slope),
            # layers.Dropout(dropout_rate),
            layers.SpectralNormalization(layers.Dense(16, name='dis_dense3', kernel_initializer=kernel_initializer)),
            layers.LeakyReLU(negative_slope=negative_slope),
            # layers.Dropout(dropout_rate),
