...
class Critic(keras.Model):
    def __init__(self, time_dim, feature_dim, n_subjects, use_sublayer, use_channel_merger, *args, **kwargs):
        ...
        self.model = keras.Sequential([
            ...
            layers.Conv1D(8, 7, strides=2, padding='same', activation='relu', name='conv4', kernel_initializer=kernel_initializer),
            layers.Conv1D(8, 5, strides=2, padding='same', activation='relu', name='conv5', kernel_initializer=kernel_initializer),
            layers.Conv1D(8, 3, strides=2, padding='same', activation='relu', name='conv6', kernel_initializer=kernel_initializer),
            ...
            layers.Dense(256, name='dis_dense1', kernel_initializer=kernel_initializer),
