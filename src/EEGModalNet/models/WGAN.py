...
class Critic(keras.Model):
    def __init__(self, time_dim, feature_dim, n_subjects, use_sublayer, use_channel_merger, *args, **kwargs):
        ...
        self.model = keras.Sequential([
            ...
            layers.Conv1D(8, 9, strides=2, padding='same', activation='relu', name='conv3', kernel_initializer=kernel_initializer),
            layers.Conv1D(8, 9, strides=2, padding='same', activation='relu', name='conv4', kernel_initializer=kernel_initializer),
            layers.Conv1D(8, 7, strides=2, padding='same', activation='relu', name='conv5', kernel_initializer=kernel_initializer),
            layers.Conv1D(8, 7, strides=2, padding='same', activation='relu', name='conv6', kernel_initializer=kernel_initializer),
            layers.Conv1D(8, 3, strides=2, padding='same', activation='relu', name='conv7', kernel_initializer=kernel_initializer),
            layers.Conv1D(8, 3, strides=2, padding='same', activation='relu', name='conv8', kernel_initializer=kernel_initializer),
            layers.Flatten(name='dis_flatten'),
            layers.Dense(64, name='dis_dense1', kernel_initializer=kernel_initializer),
            layers.LeakyReLU(negative_slope=negative_slope),
            layers.Dense(16, name='dis_dense3', kernel_initializer=kernel_initializer),
            layers.LeakyReLU(negative_slope=negative_slope),
            layers.Dense(8, name='dis_dense4', kernel_initializer=kernel_initializer),
            layers.LeakyReLU(negative_slope=negative_slope),
            layers.Dense(1, name='dis_dense5', dtype='float32', kernel_initializer=kernel_initializer),
        ], name='critic')
