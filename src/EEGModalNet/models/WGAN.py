...
class Critic(keras.Model):
    def __init__(self, time_dim, feature_dim, n_subjects, use_sublayer, use_channel_merger, *args, **kwargs):
        ...
        self.model = keras.Sequential([
            ...
            layers.Conv1D(2 * feature_dim, 3, strides=2, padding='same', name='conv3', kernel_initializer=kernel_initializer),
            ...
            SelfAttention1D(4, 8),
            layers.Conv1D(8 * feature_dim, 3, strides=2, padding='same', name='conv6', kernel_initializer=kernel_initializer),
            layers.LeakyReLU(negative_slope=negative_slope),
