...
def load_data(data_path: str,
    ...
    return {'x': x, 'sub': torch.tensor(sub), 'pos': torch.tensor(pos)}, n_subjects
...
if __name__ == '__main__':
    data, n_subs = load_data('data/LEMON_DATA/eeg_EC_BaseCorr_Norm_Clamp_with_pos.nc5',
                             n_subjects=34, channels=['O1', 'O2', 'Fp1', 'Fp2', 'C1', 'C2', 'P1', 'P2'], bandpass_filter=[1, 42], time_dim=512,  # TODO: n_subjects=202
