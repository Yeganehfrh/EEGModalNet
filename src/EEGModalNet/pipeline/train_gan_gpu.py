...
def run(data,
    ...
    lr_schedule_g = ExponentialDecay(0.000094, decay_steps=100000, decay_rate=0.90, staircase=True)
    lr_schedule_d = ExponentialDecay(0.000188, decay_steps=100000, decay_rate=0.90, staircase=True)
